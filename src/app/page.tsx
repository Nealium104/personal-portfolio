      ...
      <main className="p-10">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="flex flex-col justify-between px-10 h-full bg-bg-200 rounded-xl">
            <h2 className="text-5xl mt-8 mb-4 dark:text-primary-100 text-center">Web Developer</h2>
          ...
          <div className="flex flex-col justify-between px-10 h-full bg-bg-200 rounded-xl">
            <h2 className="text-5xl mt-8 mb-4 dark:text-primary-100 text-center">Photographer</h2>
          ...
          <div className="flex flex-col justify-between px-10 h-full bg-bg-200 rounded-xl">
            <h2 className="text-5xl mt-8 mb-4 dark:text-primary-100 text-center">Musician</h2>
