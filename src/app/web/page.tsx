...
//This was my first freelance client project. Robert Collins is a well sought after trumpet player from North Carolina who reached out
...
// Gig-Econ has been a pet project to help me in my efforts as an often gigging musician, photographer, and waiter. Very often, you need to count large sums of cash quickly.
...
// "Skunch is a rock band based here in Lexington, Kentucky. I was invited by the current lead engineer to add onto the team. The project is still in progress, but I&apos;ve been able to add value
...
// Kashmere is a local 80&apos;s cover band which I play trumpet in. Currently, the producer has me on staff as trumpet player, photographer, and web developer! This is a work in progress EPK 
