    ...
    <div className=''>
      ...
      <main className="p-10">
        <div className="flex flex-col items-center justify-center">
          ...
          height={600}
          width={600} />
          <div className='text-5xl mt-4 w-full text-center'>
            <h1 className="">
              <ChangingText />
            </h1>
          </div>
